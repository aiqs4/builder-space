...
def install_addons(cluster_info):
    """Install essential EKS add-ons (AWS-managed, auto-configured)"""
    ...
    vpc_cni = aws.eks.Addon("vpc-cni",
        ...
        addon_name="vpc-cni",
        addon_version="v1.18.5-eksbuild.1",  # Latest for 1.31
    ...
    coredns = aws.eks.Addon("coredns",
        cluster_name=cluster_name,
        addon_name="coredns",
        addon_version="v1.11.3-eksbuild.2",  # Latest for 1.31
        resolve_conflicts_on_create="OVERWRITE",
        resolve_conflicts_on_update="OVERWRITE")
    ...
    pod_identity = aws.eks.Addon("pod-identity-agent",
        ...
        addon_version="v1.3.4-eksbuild.1",  # Latest for 1.31
        resolve_conflicts_on_create="OVERWRITE",
        resolve_conflicts_on_update="OVERWRITE")
    ...
    ebs_csi = aws.eks.Addon("ebs-csi-driver",
        ...
        addon_version="v1.37.0-eksbuild.1",  # Latest for 1.31
        resolve_conflicts_on_create="OVERWRITE",
        resolve_conflicts_on_update="OVERWRITE")
